...
using W2JSoftware.Utils.EntityFrameworkCore.Extensions;
using W2JSoftware.Utils.EntityFrameworkCore.Interfaces;
using W2JSoftware.Utils.EntityFrameworkCore.Repositories;

namespace W2JSoftware.Utils.EntityFramework.Repositories
{
    /// <summary>
    /// The Repository as only one for all the commands and queries
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    /// <seealso cref="W2JSoftware.Utils.EntityFrameworkCore.Repositories.BaseRepository{TEntity}" />
    /// <seealso cref="W2JSoftware.Utils.EntityFrameworkCore.Interfaces.IGenericRepository{TEntity}" />
    /// <seealso cref="W2JSoftware.Utils.EntityFrameworkCore.Interfaces.IRepository" />
